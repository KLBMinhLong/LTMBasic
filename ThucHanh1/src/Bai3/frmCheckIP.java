 ...
 * @author Admin
 */
public class frmCheckIP extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(frmCheckIP.class.getName());

    /**
     * Creates new form frmCheckIP
     */
    public frmCheckIP() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new frmCheckIP().setVisible(true));
    }
